    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: selecionando
            ...
            : Text(widget.userId, style: const TextStyle(fontFamily: 'serif', fontWeight: FontWeight.bold)),
        ...
        child: Row(
          ...
          children: [
            ...
            FloatingActionButton.extended(
              ...
              onPressed: () async {
                if (selecionando) {
                  await deletarSelecionadosGenerico(context: context, cofre: cofre, selecionados: selecionados);
                  setState(() => selecionados.clear());
                } else {
                  await showAddOptionDialog(context: context, parentPastaId: null, cofre: cofre, onUpdate: () => setState(() {}));
                }
              },
              icon: Icon(selecionando ? Icons.delete_outline_rounded : Icons.add_rounded),
              label: Text(selecionando ? s.apagar : s.confirmButtonText.split(' ')[0]), // Simpler label for FAB
